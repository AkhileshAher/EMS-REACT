...
const CreateTask = () => {
    ...
    return (
        ...
        <div>
            <form className="sm:flex sm:w-full sm:bg-mist-900 items-center justify-between mr-6 mt-10 text-white" onSubmit={(e) => submitHandler(e)}>
                <div className="w-full sm:w-1/2 flex flex-col mr-30 m-5 gap-4">

                    <div>
                        <h3 className="text-lg font-medium pb-1">Task Title</h3>
                        <input type="text" className="border-2 border-gray-200 w-full p-2 rounded" placeholder="e.g.Prepare Report" value={taskTitle} onChange={(e) => setTaskTitle(e.target.value)} />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" className="border-2 border-gray-200 w-full p-2 rounded" placeholder="e.g.Inventory,Desk" value={category} onChange={(e) => setCategory(e.target.value)} />
                    </div>

                </div>

                <div className="w-full sm:w-1/2 flex flex-col lg:mr-30 m-5 gap-4">
